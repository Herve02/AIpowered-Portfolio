          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              {portfolioData.projects.map((project, index) => (
                <Card
                  key={project.id}
                  className={`overflow-hidden hover:shadow-xl transition-all duration-300 group hover:-translate-y-2 animate-in slide-in-from-bottom-5 duration-700`}
                  style={{ animationDelay: `${index * 200}ms` }}
                >
                  {/* Project Image */}
                  <div className="relative aspect-video bg-muted/50 overflow-hidden">
                    <img
                      src={`/abstract-geometric-shapes.png?height=400&width=600&query=${project.title} project screenshot interface`}
                      ...
                      <div className="flex flex-wrap gap-2">
                        {project.tech.map((tech, techIndex) => (
                          <Badge
                            key={tech}
                            variant="outline"
                            className={`text-xs bg-secondary/10 text-secondary border-secondary/20 hover:bg-secondary/20 transition-colors duration-200 animate-in fade-in-50 duration-500`}
            ...
            <div className="text-center mt-16 animate-in slide-in-from-bottom-5 duration-700 delay-800">
              <Card className="p-12 bg-gradient-to-br from-primary/5 to-secondary/5 border-primary/20 hover:shadow-lg transition-shadow duration-300">
                ...
                <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
                  I'm always excited to take on new challenges and create amazing digital experiences. Let's discuss how
